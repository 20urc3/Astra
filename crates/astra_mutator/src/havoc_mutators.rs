...
pub type MutatorFunction = fn(&mut Vec<u8>, u32);

/// Flips a random bit in a random byte
pub fn bit_flip(input: &mut Vec<u8>, length: u32) {
...
pub fn bytes_swap(input: &mut Vec<u8>, length: u32) {
    let mut rng = rand::rng();
...
pub fn bytes_insert(input: &mut Vec<u8>,  length: u32) {
    let mut rng = rand::rng();
    let byte_index = rng.random_range(0..length) as usize;
...
pub fn bytes_delete(input: &mut Vec<u8>,  length: u32) {
    if length > 23 {
        let mut rng = rand::rng();
        let byte_index = rng.random_range(0..length) as usize;
...
pub fn bytes_inc(input: &mut Vec<u8>,  length: u32) {
    let mut rng = rand::rng();
    let byte_index = rng.random_range(0..length) as usize;
...
pub fn bytes_dec(input: &mut Vec<u8>,  length: u32) {
    let mut rng = rand::rng();
    let byte_index = rng.random_range(0..length) as usize;
...
pub fn bytes_neg(input: &mut Vec<u8>,  length: u32) {
    let mut rng = rand::rng();
    let byte_index = rng.random_range(0..length) as usize;
...
pub fn bytes_rand(input: &mut Vec<u8>,  length: u32) {
    let mut rng = rand::rng();
    let byte_index = rng.random_range(0..length) as usize;
...
pub fn bytes_copy(input: &mut Vec<u8>, length: u32) {
    let mut rng = rand::rng();
    let byte_index = rng.random_range(0..length) as usize;
...
pub fn bytes_expand(input: &mut Vec<u8>, length: u32) {
...
pub fn byte_shrink(input: &mut Vec<u8>,  length: u32) {
    if length > 23 { 
    input.pop();
    }
}